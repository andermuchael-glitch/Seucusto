...
object CostCalculationService{
 ...
 fun calculateVariableFromCost(base:BigDecimal,percent:BigDecimal)=base*percent/BigDecimal(100)
 fun calculateVariableFromSale(price:BigDecimal,percent:BigDecimal)=price*percent/BigDecimal(100)
